...
- Static JSON-LD / FAQ schema on home and calculator pages
- `llms.txt` and GEO-oriented content blocks in `SEOConfig.json`
- Squirrel audit config (`squirrel.toml`)

## Documentation gaps

- Feature docs for blog, AdSense, and GEO/AEO optimizations
- User-facing docs in `docs/superpowers/specs/` not yet summarized in KB

## Maintenance notes

- Add a `features/NNN-*.md` file for each new user-facing feature.
- Update this index table when features ship or are deprecated.
